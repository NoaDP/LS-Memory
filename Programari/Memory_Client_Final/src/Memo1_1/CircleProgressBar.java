...
public class CircleProgressBar extends JPanel {
	...
	/**
	 * Constructor sense parametres de la classe CircleProgressBar.
	 */
	public CircleProgressBar(Client client) {
		this.client = client;
	}
	...
	/**
	 * Setter pel parametre progress.
	 * @param progress : rep el enter progress que indica el "temps"
	 */
	...
	/**
	 * Getter del progres (temps).
	 * @return Progress : parametre que indica el temps
	 */
