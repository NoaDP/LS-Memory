...
public class MachineNormal {
	
	/**
	 * La classe MachineNormal és l'encarregada de gestionar els moviments de la màquina. Primerament es barrejen 
	 * les cartes que queden de forma aleatòria i es selecciona la primera de la llista.Un cop seleccionada se 
	 * selecciona la segona. En cas de que el comptador no hagui arribat a 0 es buscarà la seva parella, en cas 
	 * contrari la segona es selecciona de forma aleatòria. Un cop seleccionades s'envien a MachineBoard per a 
	 * que se li assignin les imatges corresponents segons la id i el nivell. Un cop seleccionades es comproven 
	 * si són iguals. En cas de que ho siguin la màquina tornarà a tirar, és a dir, repetirà el procés de selecció 
	 * de cartes. En cas contrari, es crida a la classe GiraCartesThread per a que torni a col·locar les cartes en 
	 * la seva posició original i després acaba el seu torn.  
	 */
	 ...
	 * @param comptador: Variable tipus int que determina els torns que li queden a la màquina per aplicar la memòria.
	 */
